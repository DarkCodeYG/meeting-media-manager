<template>
  ...
  >
    ...
    >
      ...
      <div
        v-if="showPreMeetingClock"
        id="preMeetingClockContainer"
        :class="{ 'clock-fade-in': showPreMeetingClock }"
      >
        <!-- eslint-disable-next-line vue/no-v-html -->
...
/* Pre-meeting clock fade-in animation (v-if handles removal, no layout shift) */
...
:deep(#preMeetingClockContainer.clock-fade-in) {
  animation: clockFadeIn 0.8s ease;
}
