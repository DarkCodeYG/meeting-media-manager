...
- **상태**: 5건 모두 수정 완료 — 수동 추가 영상 `100878ef9`(custom.1) / `.jwpub` 관문 custom.6 / mediator API 공백 custom.7 / 추출 타이밍 custom.7 / **자막 위치 custom.8**
- **작성일**: 2026-08-05 / **최종 갱신**: 2026-08-07 (자막 위치 추가)
...
| 절  | 내용                                                                  | 상태          |
| --- | --------------------------------------------------------------------- | ------------- |
| 0.0 | 출처에 따라 자막 위치가 달라짐                                        | custom.8 수정 |
