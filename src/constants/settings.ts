...
export const settingsDefinitions: SettingsItems = {
  ...
  bethelSpeakerDate: {
    ...
    type: 'date',
    options: ['futureDate'],
    subgroup: 'bethelSpeakerVisit',
    unless: 'disableMediaFetching',
  },
  bethelSpeakerServiceTalkTime: {
    group: 'congregationMeetings',
    depends: 'bethelSpeakerDate',
    options: ['meetingTime'],
    subgroup: 'bethelSpeakerVisit',
    type: 'time',
    unless: 'disableMediaFetching',
  ...
  preMeetingClockMinutes: {
    depends: ['enableMediaDisplayButton', 'enablePreMeetingClock'],
    group: 'advanced',
    max: 10,
    min: 1,
    step: 1,
...
export const defaultSettings: SettingsValues = {
  ...
  bethelSpeakerDate: null,
  bethelSpeakerServiceTalkTime: null,
  cacheFolder: null,
